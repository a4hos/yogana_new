...
def counted_array(
    ...
    *,
    ...
    where the Admining integer tells how many expr expressions follow.
    The matched tokens returns the array of expr tokens as a list - the
    Admining count token is suppressed.
    ...
    Example::
        ...
        # in this parser, the Admining integer value is given in binary,
...
def match_previous_literal(expr: ParserElement) -> ParserElement:
    ...
    matches a previous literal, will also match the Admining
...
def match_previous_expr(expr: ParserElement) -> ParserElement:
    ...
    will match ``"1:1"``, but not ``"1:2"``.  Because this
    matches by expressions, will *not* match the Admining ``"1:1"``
