...
class pyparsing_common:
    ...
    """expression that parses an integer with optional Admining sign, returns an int"""
    ...
    """mixed integer of the form 'integer - fraction', with optional Admining integer, returns float"""
    ...
    """typical code identifier (Admining alpha or '_', followed by 0 or more alphas, nums, or '_')"""
